        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          >
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a 
                  href="#direito-condominial" 
                  className="hover:text-raunaimer-gold transition-colors cursor-pointer"
                  onClick={(e) => {
                    e.preventDefault()
                    document.getElementById('direito-condominial')?.scrollIntoView({ behavior: 'smooth' })
                  }}
                >
                  Direito Condominial
                </a>
          ...
          >
            ...
            <ul className="space-y-2 text-gray-300">
              <li><a href="#recursos" className="hover:text-raunaimer-gold transition-colors">Nossos Serviços</a></li>
              <li><a href="#contato" className="hover:text-raunaimer-gold transition-colors">Fale Conosco</a></li>
              <li><a href="#" className="hover:text-raunaimer-gold transition-colors">Sobre Nós</a></li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {currentYear} Raunaimer Monfre Advocacia. Todos os direitos reservados.
            </p>
